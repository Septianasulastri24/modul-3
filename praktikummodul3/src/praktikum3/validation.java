...
public class validation {
    ...
    public validation(String argWord){
        if (this.isPassLowerCase(argWord)&&this.isPassSymbol(argWord)&&this.isPassDigit(argWord)&&this.isPassUpperCase(argWord)){
            this.Freturn = true;
        }
    }
    ...
    public boolean isPassUpperCase(String argWord){
        Pattern pattern = Pattern.compile("[A-Z]+");
        Matcher matcher = pattern.matcher(argWord);
        String varFind = "";
        while (matcher.find()) {
